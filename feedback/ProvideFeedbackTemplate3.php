...
$QueryCus=" SELECT * FROM tblcustomarea WHERE ( ProfileID ={$_REQUEST['SubmitID']} AND IsActive=1 AND Template=3 )";
$ResultCus=@mysqli_query($dbc, $QueryCus);
	...
	<div style="min-height:160px; width:611px; text-align:left;">
		...
		<form id="ProvideFeedBackTemplate3Form">
			<div id="WorkHistoryFeedback">
				<textarea name="message" id="EditorFeedbackTemplate3" cols="63" rows="12" style="height:190px; width:527px; border:0px; float:left; "></textarea>				
	...
	// feed back work history 
		$(function()
		{
		  $('#EditorFeedbackTemplate3').wysiwyg();
